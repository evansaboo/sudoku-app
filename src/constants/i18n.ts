...
export const translations: Record<Lang, Translations> = {
  ...
  ar: {
    ...
    hard: 'صعب',
    hardDesc: 'أرقام قليلة جداً — للخبراء فقط',
    difficulty: 'الصعوبة',
    language: 'اللغة',
    ...
    invalidPuzzle: 'غير صالح — يحتوي على تعارضات',
    validPuzzle: '✓ صالح! حل وحيد.',
    noUniqueSolution: 'اللغز له حلول متعددة',
    generating: 'جارٍ التوليد…',
    hint: 'اضغط لعبة جديدة للبدء',
    hasErrors: 'يوجد أخطاء في حلك',
    undo: 'تراجع',
    notes: 'ملاحظات',
    remaining: 'متبقية',
    checkPuzzle: 'تحقق',
